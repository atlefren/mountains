/*global L:false */
var createQueryParameterString = function (params) {
    return _.map(params, function (value, key) {
        return encodeURIComponent(key) + '=' + encodeURIComponent(value);
    }).join('&');
};

var createFeatureCollection = function (features) {
    return {
...
var sendRequest = function (url, parser, callback, errorCallback) {
    return $.ajax({
        type: 'get',
        url: url,
...
var CartodbAPI = function (user, apikey) {
    'use strict';
